...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String[] id,nama,stokbarang,telp,gambar,alamat;
    int jumData;
    ...
    {
        String url = "https://gissasw.000webhostapp.com/serverch.php";
            ...
            public void onResponse(JSONArray response)
            {
                ...
                for (int i = 0; i < jumData; i++) {
                    try {
                        ...
                        stokbarang[i] = data.getString("stokbarang");
                        ...
                        for(int i=0;i<jumData;i++){
                            if(marker.getTitle().equals(nama[i])){
                                if (MarkerD[i]){
                                    ...
                                    DetailActivity.stokbarang=stokbarang[i];
                                    DetailActivity.telepon=telp[i];
                                    DetailActivity.gambar=gambar[i];
                                    DetailActivity.Lattitude=latitude[i];
                                    DetailActivity.Lontitude=longitude[i];
                                    DetailActivity.alamattt=alamat[i];
                                    ...
                                    Toast pesan = Toast.makeText(MapsActivity.this, "Silahkan klik 2 kali untuk detail", Toast.LENGTH_LONG);
